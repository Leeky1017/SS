...
_NON_RETRIABLE_ERROR_CODES = {
    "PLAN_MISSING",
    "PLAN_INVALID",
    "INPUTS_MANIFEST_MISSING",
    "INPUTS_MANIFEST_UNSAFE",
    "INPUTS_MANIFEST_INVALID",
    "INPUTS_MANIFEST_READ_FAILED",
    "DOFILE_PLAN_INVALID",
    "DOFILE_TEMPLATE_UNSUPPORTED",
    "DOFILE_INPUTS_MANIFEST_INVALID",
    "DO_TEMPLATE_PARAM_MISSING",
    "DO_TEMPLATE_PARAM_INVALID",
    "DO_TEMPLATE_CONTRACT_INVALID",
    "DO_TEMPLATE_META_INVALID",
    "DO_TEMPLATE_ARTIFACTS_WRITE_FAILED",
    "DO_TEMPLATE_OUTPUT_ARCHIVE_FAILED",
    "STATA_WORKSPACE_INVALID",
