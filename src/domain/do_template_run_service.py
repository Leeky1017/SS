...
class DoTemplateRunService:
    ...
    def run(
        ...
        *,
        ...
        run_id_final, dirs = self._init_run(job_id=job_id, template_id=template_id, run_id=run_id)
        try:
            ...
            self._finalize_job(job_id=job_id, run_id=run_id_final, artifacts=tuple(), ok=False)
            raise
    ...
    def _run_attempt(
        ...
        *,
        ...
        self._finalize_job(job_id=job_id, run_id=run_id, artifacts=combined, ok=result.ok)
    ...
    def _init_run(
        ...
        *,
        ...
        dirs = resolve_run_dirs(jobs_dir=self.jobs_dir, job_id=job_id, run_id=run_id_final)
        if dirs is None:
