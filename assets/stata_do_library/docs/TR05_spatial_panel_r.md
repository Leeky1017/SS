...
|------|-----|
| **模板ID** | TR05 |
| **Slug** | spatial_panel_r |
| **名称(中文)** | 空间面板R |
| **Name(EN)** | Spatial Panel R |
| **家族** | spatial |
| **等级** | L2 |
| **版本** | 2.0.0 |
...
| 文件 | 类型 | 说明 |
|------|------|------|
| data_TR05_sp_panel.dta | data | Auto-synced from SS_OUTPUT_FILE anchors |
| result.log | log | Execution log |
| table_TR05_spatial_panel.csv | table | Auto-synced from SS_OUTPUT_FILE anchors |
