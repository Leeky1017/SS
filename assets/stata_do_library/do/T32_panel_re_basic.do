...
*   - table_T32_paper.rtf type=table desc="Publication-quality table"
...
if `has_esttab' {
    display ""
    display ">>> 导出论文级表格: table_T32_paper.rtf"
    
    esttab using "table_T32_paper.rtf", replace ///
    ...
    display "SS_OUTPUT_FILE|file=table_T32_paper.rtf|type=table|desc=publication_table"
    display ">>> 论文级表格已导出 ✓"
}
else {
    display ""
