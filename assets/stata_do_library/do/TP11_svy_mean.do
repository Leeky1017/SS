* ==============================================================================
* SS_TEMPLATE: id=TP11  level=L1  module=P  title="Svy Mean"
* INPUTS:
*   - data.csv  role=main_dataset  required=yes
* OUTPUTS:
*   - table_TP11_svymean.csv type=table desc="Survey mean results"
*   - data_TP11_svy.dta type=data desc="Output data"
...
display "SS_TASK_END|id=TP11|status=ok|elapsed_sec=`elapsed'"
log close
