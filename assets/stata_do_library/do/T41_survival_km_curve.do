...
program define ss_fail_T41
    ...
    display "SS_TASK_END|id=T41|status=fail|elapsed_sec=`elapsed'"
    capture log close
    if _rc != 0 {
...
if _rc {
    ...
    if _rc {
        ...
        ss_fail_T41 601 "confirm file" "data_file_not_found"
    }
...
if r(N) > 0 {
    ...
    ss_fail_T41 200 "runtime" "task_failed"
}
