...
*   - fig_TK16_value.png type=figure desc="Value chart"
...
* 按时间截面对BM分组
bysort `time_var': egen bm_rank = xtile(`bm_var'), n(`n_groups')
...
display "SS_OUTPUT_FILE|file=fig_TK16_value.png|type=figure|desc=value_chart"
restore
