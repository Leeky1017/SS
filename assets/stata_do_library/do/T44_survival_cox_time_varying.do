...
* - 2026-01-08: Keep time-varying covariate handling and document data structure requirements (保留时变协变量设定并明确数据结构要求).
* ==============================================================================
...
program define ss_fail_T44
    ...
    display "SS_TASK_END|id=T44|status=fail|elapsed_sec=`elapsed'"
    capture log close
    if _rc != 0 {
...
if _rc {
    ...
    if _rc {
        ...
        ss_fail_T44 601 "confirm file" "data_file_not_found"
    }
