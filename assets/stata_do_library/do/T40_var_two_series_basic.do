...
* - 2026-01-08: Keep VAR workflow with lag selection and impulse response analysis outputs (保留 VAR 滞后选择与脉冲响应分析).
* ==============================================================================
...
program define ss_fail_T40
    ...
    display "SS_TASK_END|id=T40|status=fail|elapsed_sec=`elapsed'"
    capture log close
    if _rc != 0 {
...
if _rc {
    ...
    if _rc {
        ...
        ss_fail_T40 601 "confirm file" "data_file_not_found"
    }
