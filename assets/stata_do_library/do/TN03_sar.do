* ==============================================================================
* SS_TEMPLATE: id=TN03  level=L1  module=N  title="SAR"
* INPUTS:
*   - data.csv  role=main_dataset  required=yes
* OUTPUTS:
*   - table_TN03_sar.csv type=table desc="SAR results"
*   - data_TN03_sar.dta type=data desc="Output data"
...
program define ss_fail_TN03
    ...
    display "SS_TASK_END|id=TN03|status=fail|elapsed_sec=`elapsed'"
    capture log close
    exit `code'
end
...
if _rc {
    ss_fail_TN03 601 "confirm file data.csv" "input_file_not_found"
}
...
display "SS_TASK_END|id=TN03|status=ok|elapsed_sec=`elapsed'"
log close
