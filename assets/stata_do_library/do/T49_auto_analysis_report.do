...
* - 2026-01-08: Keep end-to-end automated report (describe/missingness/descriptives/corr/reg) with exported artifacts (保留一键报告并输出可追踪产物).
* ==============================================================================
...
program define ss_fail_T49
    ...
    display "SS_TASK_END|id=T49|status=fail|elapsed_sec=`elapsed'"
    capture log close
    if _rc != 0 {
...
if _rc {
    ...
    if _rc {
        ...
        ss_fail_T49 601 "confirm file" "data_file_not_found"
    }
