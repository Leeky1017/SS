...
* OUTPUTS:
*   - fig_TJ06_ca.png type=figure desc="CA plot"
...
ca `var1' `var2'
cabiplot, autoaspect
graph export "fig_TJ06_ca.png", replace width(1200)
display "SS_OUTPUT_FILE|file=fig_TJ06_ca.png|type=figure|desc=ca_plot"
