...
program define ss_fail_T22
    ...
    display "SS_TASK_END|id=T22|status=fail|elapsed_sec=`elapsed'"
    capture log close
    if _rc != 0 {
...
if _rc {
    ...
    if _rc {
        ...
        ss_fail_T22 601 "confirm file" "data_file_not_found"
    }
