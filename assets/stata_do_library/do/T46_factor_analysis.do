...
* - 2026-01-08: Keep EFA workflow (factor extraction + rotation) and export loadings/scores (保留因子分析流程并导出结果).
* ==============================================================================
...
program define ss_fail_T46
    ...
    display "SS_TASK_END|id=T46|status=fail|elapsed_sec=`elapsed'"
    capture log close
    if _rc != 0 {
...
if _rc {
    ...
    if _rc {
        ...
        ss_fail_T46 601 "confirm file" "data_file_not_found"
    }
