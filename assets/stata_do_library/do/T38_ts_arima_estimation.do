...
* - 2026-01-08: Keep ARIMA estimation with explicit (p,d,q) inputs and export diagnostics/forecasts (保留 ARIMA 估计并明确阶数设定).
* ==============================================================================
...
program define ss_fail_T38
    ...
    display "SS_TASK_END|id=T38|status=fail|elapsed_sec=`elapsed'"
    capture log close
    if _rc != 0 {
...
if _rc {
    ...
    if _rc {
        ...
        ss_fail_T38 601 "confirm file" "data_file_not_found"
    }
