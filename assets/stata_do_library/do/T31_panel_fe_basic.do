...
program define ss_fail_T31
    ...
    display "SS_TASK_END|id=T31|status=fail|elapsed_sec=`elapsed'"
    capture log close
    if _rc != 0 {
...
if _rc {
    ...
    if _rc {
        ...
        ss_fail_T31 601 "confirm file" "data_file_not_found"
    }
...
if _rc {
    ...
    ss_fail_T31 200 "runtime" "task_failed"
}
