* ==============================================================================
* SS_TEMPLATE: id=TP12  level=L1  module=P  title="Svy Regress"
* INPUTS:
*   - data.csv  role=main_dataset  required=yes
* OUTPUTS:
*   - table_TP12_svyreg.csv type=table desc="Survey regression results"
*   - data_TP12_svy.dta type=data desc="Output data"
...
display "SS_TASK_END|id=TP12|status=ok|elapsed_sec=`elapsed'"
log close
