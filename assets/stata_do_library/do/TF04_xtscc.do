...
capture which xtscc
if _rc {
    display "SS_DEP_MISSING:xtscc"
    display "SS_ERROR:DEP_MISSING:xtscc not installed"
    display "SS_ERR:DEP_MISSING:xtscc not installed"
    log close
    exit 199
}
