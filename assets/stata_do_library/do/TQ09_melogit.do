...
melogit `depvar' `indepvars' || `group_var':, or
local ll = e(ll)
...
clear
set obs 1
gen str32 model = "Multilevel Logit"
gen double ll = `ll'
export delimited using "table_TQ09_melogit.csv", replace
display "SS_OUTPUT_FILE|file=table_TQ09_melogit.csv|type=table|desc=melogit_results"
restore

local n_output = _N
display "SS_METRIC|name=n_output|value=`n_output'"
save "data_TQ09_melogit.dta", replace
