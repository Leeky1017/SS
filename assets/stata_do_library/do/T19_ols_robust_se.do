...
*   - table_T19_paper.docx type=report desc="Publication table (docx via putdocx)"
...
* - Error policy: fail on missing vars or empty sample / 错误策略：关键变量缺失或空样本→fail
* ==============================================================================
display "SS_BP_REVIEW|issue=193|template_id=T19|ssc=removed|output=csv_docx|policy=warn_fail"
...
* SECTION 2: 异方差检验
* ==============================================================================
* [ZH] S03 估计稳健标准误 OLS，进行异方差检验与诊断
* [EN] S03 Estimate robust-VCV OLS and run heteroskedasticity diagnostics
...
display ""
display ">>> 导出论文表（docx）: table_T19_paper.docx"
putdocx clear
putdocx begin
putdocx paragraph, style(Heading1)
putdocx text ("T19: OLS with Robust SE / 稳健标准误 OLS")
putdocx paragraph
putdocx text ("Model: regress `dep_var' `indep_vars', vce(robust)")
putdocx table t1 = data(variable coef robust_se t p sig), varnames
putdocx save "table_T19_paper.docx", replace
display "SS_OUTPUT_FILE|file=table_T19_paper.docx|type=report|desc=publication_table_docx"
display ">>> 论文表（docx）已导出: table_T19_paper.docx"
restore
...
display "  - table_T19_paper.docx         论文表（putdocx 导出）"
